...
/**
 * 路由跳转的跳卡，跳卡根据路由地址来跳转，跳卡还可以设置跳转动画，传递参数等。
 */
public class JumpCard extends RouterMeta {
    ...
    public Object navigation() {
        return JumpRouter.get().navigation(null, this, -1);
    }

    public Object navigation(Context context) {
        return JumpRouter.get().navigation(context, this, -1);
    }

    public Object navigation(Context context, int requestCode) {
        return JumpRouter.get().navigation(context, this, requestCode);
    }
}
